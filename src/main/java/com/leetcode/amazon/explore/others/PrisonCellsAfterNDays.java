...
public class PrisonCellsAfterNDays {
    ...
    // Code works but time limit exceeded on leetcode -> own idea
    // Time: O(N * l) -> N number of days, l length of cells
    // Space: O(l)
    ...
    // Leetcode way: did not practice
    // O(2^N)
    // SPace: O(2^N * N)
    public int[] prisonAfterNDaysBestCase(int[] cells, int N) {
